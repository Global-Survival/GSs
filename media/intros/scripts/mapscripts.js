...
(function() { 
if (typeof canvasApp !== 'function' && typeof canvasApp[0] === 'undefined') {
      ...
      for (var i = adiv.children.length; i > 0; i -= 1) {
        ...
        switch (child.tagName) {
          ...
          case "A":
            ...
            adiv.replaceChild($(arep.cloneNode(true)).css({color:"#FFF",fontSize:"1.5em"})[0],child);
            break;
          case "a":
            var innerdiv = this.getDivText(child);
            arep.innerHTML = innerdiv;
          ...
          case "EM":
            var innerdiv = this.getDivText(child);
            arep.innerHTML = innerdiv;
            adiv.replaceChild($(arep.cloneNode(true)).css("color","#FFF")[0],child);
            break;
          case "em":
            var innerdiv = this.getDivText(child);
            arep.innerHTML = innerdiv;
